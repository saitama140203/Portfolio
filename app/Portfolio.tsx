...
const CVPreviewModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    return (
        ...
        >
            ...
            {/* Modal content */}
            <div
                className="relative z-10 w-full max-w-4xl h-[85vh] bg-neutral-900 border border-neutral-700 rounded-2xl overflow-hidden shadow-2xl shadow-purple-500/10 animate-modalSlideUp"
            ...
            >
                ...
                {/* PDF iframe */}
                <div className="h-[calc(85vh-65px)] bg-neutral-800">
                    <iframe
                        src="/cv.pdf"
                        title="CV Preview"
